...
namespace Proyecto_Final_Web.Controllers
{
    ...
    public class EstadosReservasController : Controller
    {
        ...
        public EstadosReservasController(BDCanchasContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdEstadoReserva,Nombre,Descripcion")] EstadosReserva estadosReserva)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEstadoReserva,Nombre,Descripcion")] EstadosReserva estadosReserva)
        {
